    ...
    return (
        <div>
            ...
            <div className="input-container">
                ...
                <input type="text" onChange={(event) => {setSex(event.target.value)}} placeholder="Sex" />
                <input type="text" onChange={(event) => {setSpecies(event.target.value)}} placeholder="Species" />
